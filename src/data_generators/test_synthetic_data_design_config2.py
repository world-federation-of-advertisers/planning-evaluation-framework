...
class TestSyntheticDataDesignConfig2(SyntheticDataDesignConfig):
    ...
    def get_data_set_params_list(
        ...
        return [cls.get_data_set_params(random_generator)]

    @classmethod
    def get_data_set_params(cls, random_generator: Generator) -> DataSetParameters:
        ...
        return DataSetParameters(
            ...
            impression_generator_params=GeneratorParameters(
                ...
                params={"poisson_lambda": 0.1, "random_generator": random_generator},
            ),
