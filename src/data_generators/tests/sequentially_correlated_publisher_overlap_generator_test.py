...
from wfa_planning_evaluation_framework.data_generators.sequentially_correlated_publisher_overlap_generator import (
    SequentiallyCorrelatedPublisherOverlapGenerator,
    OrderOptions,
    CorrelatedSetsOptions,
)


class SequentiallyCorrelatedPublisherOverlapGeneratorTest(absltest.TestCase):
  ...
  def test_sequentially_correlated_publisher_overlap_generator(self):
    ...
    gen = SequentiallyCorrelatedPublisherOverlapGenerator()
