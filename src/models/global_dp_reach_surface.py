...
class GlobalDpReachSurface(ReachSurface):
    """Predicts subset reach by deduplicating local DP LiquidLegions."""

    def __init__(self, global_dp_simulator: GlobalDpSimulator):
        self.global_dp_simulator = global_dp_simulator
    ...
    def by_spend(self, spend: List[float], max_frequency: int = 1) -> ReachPoint:
        ...
        return self.global_dp_simulator.simulated_reach_by_spend(spend, max_frequency)
