...
from wfa_planning_evaluation_framework.models.restricted_pairwise_union_reach_surface import RestrictedPairwiseUnionReachSurface
...
class RestrictedPairwiseUnionReachSurfaceTest(absltest.TestCase):
  ...
  def test_by_impressions(self):
    ...
    surface = RestrictedPairwiseUnionReachSurface(reach_curves,
